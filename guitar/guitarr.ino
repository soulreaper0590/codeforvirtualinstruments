...
//Serial.println(pitch);
    if(pitchprev>0){
      if(pitchnow<0)
      {
        ...
        float finger1 = analogRead(4);
        float finger2 = analogRead(3);
        float finger3 = analogRead(1);
        float finger4 = analogRead(2);
       ...
       Serial.print(finger3);Serial.print("\t");
       Serial.print(finger4);Serial.println("\t");*/
        //Serial.print("\t");
                  if(finger11==2&&finger22==2&&finger33==2&&finger44==2){
                    Serial.println("f");
                    BTserial.write("f");
                  }
                  else if(finger11==2&&finger22==0&&finger33==0&&finger44==0){
                    Serial.println("F");
                    BTserial.write("F");
                  }

                  else if(finger11==2&&finger22==2&&finger33==2&&finger44==1){
                    Serial.println("d");
                    BTserial.write("d");
                  }
                  else if(finger11==2&&finger22==2&&finger33==2&&finger44==0){
                    Serial.println("A");
                    BTserial.write("A");
                  }
                  else if(finger11==0&&finger22==2&&finger33==2&&finger44==1){
                    Serial.println("C");
                    BTserial.write("C");
                  }
                  else if(finger11==0&&finger22==1&&finger33==2&&finger44==2){
                    Serial.println("B");
                    BTserial.write("B");
                  }
                   //Serial.print("hit");
